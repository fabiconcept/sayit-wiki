...
export class NoBadWord {
    ...
    /**
     * Creates a new NoBadWord instance
     * 
     * @constructor
     ...
     * 
     * // Custom settings
     * const strictModerator = new NoBadWord(ModerationLevel.STRICT, '#');
     * 
     * // Relaxed moderation
     * const relaxedModerator = new NoBadWord(ModerationLevel.RELAXED);
     * ```
     */
    constructor(
     ...
     * const moderator2 = new NoBadWord(ModerationLevel.MODERATE, '#');
    ...
    countBySeverity(content: string): {
        ...
        for (const match of result.matches) {
            counts[match.severity as keyof typeof counts]++;
            counts.total++;
        }
